...
describe('BigBitSet', function(){
    ...
    it.skip('should support proxy-style access', function(){
		...
		assert.equal(bitset[15], bitset.get(15));
    ...
    it('should iterate through the bitLength correctly', function(){
        bitset.set(0, true);
        bitset.set(1, true);
        bitset.set(63, true);
...
describe('PowerSet', function(){
	...
	it.skip('demo', function(){
		...
		logger.info(`PowerSet: ${end-start} ms (${psCount} elems)`);
	});
